...
public interface InterCrud<T extends Serializable>{        
    Collection<T> allFields(PersistenceManagerFactory pmf,PersistenceManager pm,Long limitInicio,Long limitFin,boolean loadSubClase,String[] members,Integer maxFetchDepth,String filter,Map paramValue,String order)throws UnknownException;
    ...
    Collection<T> allFields(PersistenceManagerFactory pmf,PersistenceManager pm,boolean loadSubClase,String[] members, Integer maxFetchDepth,String filter,Map paramValue,String order)throws UnknownException;    
    ...
    Collection<T> allFields(PersistenceManagerFactory pmf,PersistenceManager pm)throws UnknownException;    
    Collection<T> allFields()throws UnknownException;    
    T allFields(PersistenceManagerFactory pmf,PersistenceManager pm,boolean loadSubClase,String[] members, Integer maxFetchDepth,Long idEntity,String fieldId)throws UnknownException;    
    ...
    T allFields(PersistenceManagerFactory pmf,PersistenceManager pm,boolean loadSubClase,String[] members, Integer maxFetchDepth,String idEntity,String fieldId,boolean isIdTypeDataCharacter)throws UnknownException;    
    ...
    Collection<T> customField(PersistenceManagerFactory pmf,PersistenceManager pm,boolean loadSubClase,String[] members, Integer maxFetchDepth,String fields,String filter,Map paramValue,String order)throws UnknownException;
    ...
    Collection<T> customField(PersistenceManagerFactory pmf,PersistenceManager pm,boolean loadSubClase,String[] members, Integer maxFetchDepth,Long limitInicio, Long limitFin,String fields,String filter,Map paramValue,String order)throws UnknownException;
    ...
    T customField(PersistenceManagerFactory pmf,PersistenceManager pm,boolean loadSubClase,String[] members, Integer maxFetchDepth,String fields,Long idEntity,String fieldId)throws UnknownException;    
    ...
    T customField(PersistenceManagerFactory pmf,PersistenceManager pm,boolean loadSubClase,String[] members, Integer maxFetchDepth,String fields,String idEntity,String fieldId,boolean isIdTypeDataCharacter)throws UnknownException;    
    ...
    T find(PersistenceManagerFactory pmf,PersistenceManager pm,String[] members, Integer maxFetchDepth,Object id)throws UnknownException;    
    T findIdChar(String[] members, Integer maxFetchDepth,String fieldId,String id)throws UnknownException;    
    T findIdChar(PersistenceManagerFactory pmf,PersistenceManager pm,String[] members, Integer maxFetchDepth,String fieldId,String id)throws UnknownException;        
