...
public class ConnectionPropertiesMongo extends AbstractConnectionProperties{
    ...
    public ConnectionPropertiesMongo(            
        ...
        super.setUrlConnection("mongodb://localhost:27017/"+nameDatabase);      
        ...
        //cluster test super.setUrlConnection("mongodb://mtoral:Maej1019@ec2-35-163-220-126.us-west-2.compute.amazonaws.com:27017,ec2-34-222-157-77.us-west-2.compute.amazonaws.com:27017/"+nameDatabase+"?retryWrites=true&w=majority&readPreference=primary&ssl=false");
        //super.setUrlConnection("mongodb://mtoral:Maej1019@ec2-34-222-109-254.us-west-2.compute.amazonaws.com:27017,ec2-52-13-6-184.us-west-2.compute.amazonaws.com:27017/"+nameDatabase+"?retryWrites=true&w=majority&readPreference=primary&ssl=false");        
    }
